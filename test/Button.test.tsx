...
describe('Button', () => {
  ...
  describe('Variants', () => {
    it('should render a primary button', () => {
      ...
      expect(buttonElement.classList.contains('bg-indigo-500')).toBe(true);
    });
    ...
    it('should render a secondary button', () => {
      ...
      expect(buttonElement.classList.contains('bg-indigo-100')).toBe(true);
    });
    ...
    it('should show a danger button', () => {
      ...
      expect(buttonElement.classList.contains('bg-red-600')).toBe(true);
    });
